  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[var(--highlight)] to-[var(--accent)]">Rock Paper Scissors</h1>
